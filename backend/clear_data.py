...
async def clear_all_data():
    ...
    collections = [
        'vehicles', 'customers', 'technicians', 'services', 'parts',
        'invoices', 'transactions', 'appointments', 'employees',
        'advances', 'salary_payments', 'loyalty_points', 'loyalty_transactions',
        'coupons', 'maintenance_reminders', 'warranties', 'warranty_claims',
        'suppliers', 'purchase_orders', 'products', 'shop_orders',
        'ai_bots', 'bot_conversations', 'ceo_alerts', 'business_metrics',
        'workshop_services', 'service_packages', 'tickets', 'ticket_responses',
        'customer_feedback', 'faqs', 'chat_sessions'
    ]
