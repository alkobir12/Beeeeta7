...
class DensoInjectorDiagnostics:
    ...
    def __init__(self):
        ...
        self.denso_specifications = {
            ...
            "G4_Generation": {
                ...
                "injector_types": ["Common Rail", "Piezoelectric", "Ultra-High Pressure"]
            },
            "HP3_System": {
    ...
    def validate_vl_mode_reading(self, engine_type: str, pressure: float, duration: float, return_quantity: float) -> Dict:
        ...
        # تحليل ضغط VL
        pressure_range = test_params.get("VL_mode_pressure", "").replace(" bar", "").split("-")
        pressure_ok = False
        ...
        try:
            ...
            return_limit = float(return_limit_str.replace("< ", "").replace(" ml/min", ""))
