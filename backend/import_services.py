...
SERVICES = [
    ...
    {"name": "تغيير جوان رأس المحرك", "category": "محرك", "price": 2500, "duration": 360},
    {"name": "تغيير صفاية البلف", "category": "محرك", "price": 1200, "duration": 180},
    {"name": "تغيير البساتم والشنابر", "category": "محرك", "price": 4000, "duration": 600},
    ...
    {"name": "إلغاء أعطال الكمبيوتر", "category": "كهرباء", "price": 300, "duration": 60},
    {"name": "تغيير بطارية السيارة", "category": "كهرباء", "price": 400, "duration": 30},
    ...
    {"name": "تغيير تيل الفرامل الأمامي", "category": "فرامل", "price": 300, "duration": 60},
    {"name": "تغيير تيل الفرامل الخلفي", "category": "فرامل", "price": 250, "duration": 45},
    ...
    {"name": "تغيير مساعدات أمامية", "category": "تعليق", "price": 1000, "duration": 120},
    ...
    {"name": "تغيير زيت القير الأوتوماتيك", "category": "قير", "price": 600, "duration": 90},
    ...
    {"name": "تغيير كمبروسر التكييف", "category": "تكييف", "price": 1500, "duration": 180},
    ...
    {"name": "صيانة دورية 5000 كم", "category": "صيانة دورية", "price": 400, "duration": 90},
    {"name": "صيانة دورية 10000 كم", "category": "صيانة دورية", "price": 600, "duration": 120},
    {"name": "صيانة دورية 20000 كم", "category": "صيانة دورية", "price": 1000, "duration": 180},
    {"name": "صيانة دورية 40000 كم", "category": "صيانة دورية", "price": 2000, "duration": 300},
    ...
    {"name": "تعبئة دولاب بالنيتروجين", "category": "خاص", "price": 150, "duration": 30},
    ...
    {"name": "تركيب نظام عادم رياضي", "category": "متقدم", "price": 4000, "duration": 240},
    {"name": "تركيب دعامية رياضية", "category": "متقدم", "price": 2000, "duration": 180},
]
...
def import_services():
    ...
    for service in SERVICES:
        try:
            ...
            existing = supabase.client.table('services').select('id').eq('name', service['name']).execute()
