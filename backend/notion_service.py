...
class NotionService:
    ...
    def __init__(self):
        ...
        if self.notion_token and NOTION_AVAILABLE:
            ...
            self.client = None
            self.mock_mode = True
            print("⚠️ Running in MOCK mode. Set NOTION_TOKEN to enable real Notion integration.")
    
    def get_customers(self, filter_condition: Optional[Dict] = None) -> List[Dict[str, Any]]:
    ...
    def create_customer(self, name: str, email: str, phone: str, 
                       company: str, notes: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.client.pages.create(
                parent={"database_id": self.customers_db},
    ...
    def _extract_page_properties(self, page: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for prop_name, prop_data in props.items():
            ...
            if prop_type == "title":
                ...
                properties[prop_name.lower()] = texts[0]["text"]["content"] if texts else ""
                ...
                properties[prop_name.lower()] = select_info.get("name") if select_info else ""
    ...
    def _get_mock_procedures(self, category: Optional[str] = None) -> List[Dict[str, Any]]:
