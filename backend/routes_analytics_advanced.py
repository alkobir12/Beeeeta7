...
async def get_financial_ratios():
    ...
    total_liabilities = sum(a['balance'] for a in accounts_db if a['type'] == 'liability')
...
async def get_profit_loss_statement(
    ...
    operating_exp = sum(a['balance'] for a in accounts_db if a['code'] in ['5003', '5004', '5005'])
    ...
    return {
        ...
        "gross_margin_percentage": round((gross_profit / total_revenue * 100) if total_revenue > 0 else 0, 2),
        "operating_expenses": {
            "salaries": salaries,
            "other": operating_exp,
        ...
        "net_margin_percentage": round((net_profit / total_revenue * 100) if total_revenue > 0 else 0, 2)
    }
