...
async def confirm_operation_payment(op_id: str, payload: Dict[str, Any] = Body(None)):
    ...
    try:
        ...
        # Sum already-confirmed payments
        already_paid = 0.0
        try:
            prev = (
            ...
            # If schema missing source/reference_id, we can't compute already paid
        ...
        # If fully settled, flip payment_method to cash (optional)
        try:
