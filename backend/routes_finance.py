    ...
    try:
        ...
        try:
            ...
            for op in ops_response.data:
                ...
                # إضافة معلومات المركبة للوصف
                if vehicle_plate:
                    description = f"{description} - {vehicle_plate}"
                if customer_name and not vehicle_plate:
                ...
                if op_type == 'sale':
                    ...
                    entries.append({
                        ...
                        "source": "operation",
                        "vehicle_plate": vehicle_plate,
                        "customer_name": customer_name or op.get('partner_name', '')
                    })
        except Exception as e:
