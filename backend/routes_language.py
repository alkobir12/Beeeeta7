...
from language_dictionary import (
    ENGINE_TERMS, FUEL_SYSTEM_TERMS, COOLING_SYSTEM_TERMS, ELECTRICAL_SYSTEM_TERMS,
    IGNITION_SYSTEM_TERMS, BRAKE_SYSTEM_TERMS, SUSPENSION_SYSTEM_TERMS,
    TRANSMISSION_SYSTEM_TERMS, EXHAUST_SYSTEM_TERMS, TIRES_WHEELS_TERMS,
    TOOLS_MEASUREMENTS_TERMS, GENERAL_TERMS, FINANCIAL_TERMS,
    SALES_PURCHASE_TERMS, TECHNICAL_TERMS, MECHANICAL_SERVICES_TERMS,
