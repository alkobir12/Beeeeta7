...
async def run_moltbot_chat(payload: MoltbotChatRequest):
    ...
    thinking_keys_prompt = (
        "مفاتيح التفكير العشرين التي يجب الالتزام بها داخليًا أثناء التحليل:\n"
        "- التفكير التحليلي: تحليل المشكلة إلى أجزاء أصغر وفهم العلاقات بينها قبل كتابة أي كود.\n"
        "- التفكير التجريدي: فصل التفاصيل غير المهمة والتركيز على البنية العامة للمشكلة أو النظام.\n"
        "- التفكير المنطقي: استخدام المنطق في التحقق من الشروط والتفرعات والعمليات الحسابية.\n"
        "- حل المشكلات: إيجاد حلول قابلة للتطبيق للمشاكل البرمجية المختلفة.\n"
        "- التفكير الخوارزمي: صياغة خطوات واضحة ومحددة لحل مشكلة معينة، أي كتابة خوارزمية.\n"
        "- التفكير التجريبي: تجربة الأفكار المختلفة بسرعة لمعرفة أيها يعمل قبل الالتزام بحل كامل.\n"
        "- التفكير الإبداعي: البحث عن حلول غير تقليدية ومبتكرة لتجاوز قيود المشكلة.\n"
        "- التفكير العكسي: البدء من النتيجة المطلوبة والرجوع إلى الخطوات اللازمة للوصول إليها.\n"
        "- التفكير البنيوي: تنظيم الكود والبيانات بشكل واضح ومنطقي، مع مراعاة القابلية للتوسع والصيانة.\n"
        "- التفكير التتابعي: معالجة المشكلة خطوة خطوة مع مراعاة الترتيب المنطقي للأوامر والتعليمات.\n"
        "- التفكير المقارن: مقارنة الحلول المختلفة واختيار الأنسب بناءً على الأداء أو البساطة.\n"
        "- التفكير التجميعي: جمع أجزاء متعددة من المعلومات أو البيانات لتكوين صورة كاملة أو حل متكامل.\n"
        "- التفكير النقدي: تقييم صحة الحلول والأفكار وعدم قبول أي شيء دون تحليل منطقي.\n"
        "- التفكير الميتا: التفكير في كيفية التفكير نفسه، أي مراجعة أسلوبك البرمجي وتحسينه.\n"
        "- التفكير المنظم: استخدام أساليب منهجية مثل المخططات الانسيابية أو Pseudocode.\n"
        "- التفكير الرياضي: القدرة على التعامل مع العمليات الحسابية والمنطقية المعقدة بكفاءة.\n"
        "- التفكير التجريبي المستمر: اختبار الحلول بشكل مستمر وتحسين الكود iteratively.\n"
        "- التفكير الحدودي: التفكير في الحالات الخاصة أو القيم القصوى لضمان قوة واستقرار البرنامج.\n"
        "- التفكير التكيفي: القدرة على تعديل الحلول عند مواجهة متغيرات أو متطلبات جديدة.\n"
        "- التفكير التعاوني: القدرة على العمل ضمن فرق برمجية وفهم أفكار الآخرين ودمجها في الحلول."
    )
