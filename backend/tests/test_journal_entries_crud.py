...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ledgerlink-12.preview.emergentagent.com').rstrip('/')
...
class TestJournalEntriesCRUD:
    ...
    def test_create_journal_entry(self):
        ...
        payload = {
            ...
            "lines": [
                {"account": "101", "account_name": "النقدية", "debit": 1500, "credit": 0},
                {"account": "522", "account_name": "مصاريف إيجار", "debit": 0, "credit": 1500}
            ],
            "total": 1500
        }
        ...
        assert data.get("message") == "تم إنشاء القيد المحاسبي بنجاح", "Should return success message"
    ...
    def test_get_single_journal_entry(self):
        ...
        payload = {
            ...
            "lines": [
                {"account": "101", "account_name": "النقدية", "debit": 500, "credit": 0},
                {"account": "411", "account_name": "إيرادات خدمات الصيانة", "debit": 0, "credit": 500}
            ],
            "total": 500
        }
        ...
        assert entry["description"] == payload["description"], "Description should match"
    ...
    def test_update_journal_entry(self):
        ...
        payload = {
            ...
            "lines": [
                ...
                {"account": "522", "account_name": "مصاريف إيجار", "debit": 0, "credit": 1000}
            ],
            "total": 1000
        }
        ...
        update_payload = {
            ...
            "lines": [
                {"account": "101", "account_name": "النقدية", "debit": 2000, "credit": 0},
                {"account": "522", "account_name": "مصاريف إيجار", "debit": 0, "credit": 2000}
            ],
            "total": 2000
        }
        ...
        data = response.json()
        assert data.get("success") == True, "Response should have success=True"
        assert data.get("message") == "تم تحديث القيد المحاسبي بنجاح", "Should return success message"
    ...
    def test_delete_journal_entry(self):
        ...
        payload = {
            ...
            "lines": [
                {"account": "101", "account_name": "النقدية", "debit": 750, "credit": 0},
                {"account": "411", "account_name": "إيرادات خدمات الصيانة", "debit": 0, "credit": 750}
            ],
            "total": 750
        }
        ...
        data = response.json()
        assert data.get("success") == True, "Response should have success=True"
        assert data.get("message") == "تم حذف القيد المحاسبي بنجاح", "Should return success message"
    ...
    def test_list_journal_entries(self):
        ...
        print(f"✅ List entries works - Total: {len(data['data'])}, Manual: {len(manual_entries)}, Operations: {len(operation_entries)}")
