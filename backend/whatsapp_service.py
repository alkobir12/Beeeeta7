...
class WhatsAppService:
    ...
    async def _generate_deeplink(self, to_phone: str, message: str) -> Dict[str, Any]:
        ...
        return {"status": "deeplink_generated", "deeplink": deeplink}
    ...
    async def send_otp(self, phone: str, code: str) -> Dict[str, Any]:
        ...
        return await self.send_message(
            to_phone=phone, message=message, message_type="otp", metadata={"code": code}
        )
    ...
    async def get_messages(
        ...
        messages = (
            await self.db.whatsapp_messages.find(query)
            .sort("created_at", -1)
            .limit(limit)
