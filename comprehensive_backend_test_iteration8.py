...
Testing Environment: https://dual-ledger-app.preview.emergentagent.com
...
class ComprehensiveBackendTester:
    def __init__(self):
        ...
        self.base_url = "https://dual-ledger-app.preview.emergentagent.com"
    ...
    def test_cors_preflight(self):
        ...
        try:
            headers = {
                'Origin': 'https://dual-ledger-app.preview.emergentagent.com',
    ...
    def run_all_tests(self):
        ...
        print("🎯 Target: https://dual-ledger-app.preview.emergentagent.com")
        print("=" * 80)
