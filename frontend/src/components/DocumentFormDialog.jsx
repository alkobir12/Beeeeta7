  ...
  const handlePreview = async () => {
    try {
      ...
      const renderData = {
        ...
        data: {
          WORKSHOP_NAME: workshopProfile?.name || 'ورشتي',
          WORKSHOP_NAME_EN: workshopProfile?.nameEnglish || '',
          WORKSHOP_ADDRESS: workshopProfile?.address || '',
          WORKSHOP_PHONE: workshopProfile?.phone || '',
          WORKSHOP_EMAIL: workshopProfile?.email || '',
          WORKSHOP_CITY: workshopProfile?.city || '',
          TAX_NUMBER: workshopProfile?.taxNumber || '',
          COMMERCIAL_REGISTER: workshopProfile?.commercialRegister || '',
