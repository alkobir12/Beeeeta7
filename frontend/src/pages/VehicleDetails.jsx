...
const VisitCard = ({ visit, vehicle, technicians, onUpdate, onDelete, onVisitClosed, approvals = [], servicesCatalog = [], partsCatalog = [], onServiceAdded, onPartAdded, canDelete = false }) => {
