...
const translations = {
  ...
  abu_fahad: {
    title: "أبوفهد",
    subtitle: "مساعد مالي",
    greeting: "مرحباً، أنا أبوفهد. ماذا تريد أن نراجع اليوم؟ يمكنك اختيار حساب للتدقيق أو كتابة سؤالك مباشرة.",
    new_chat: "محادثة جديدة",
    new_chat_greeting: "تم بدء محادثة جديدة. ما الذي تريد تحليله الآن؟ يمكنك اختيار حساب للتدقيق أو كتابة سؤالك مباشرة.",
    open_chat: "فتح محادثة أبوفهد",
    account_optional: "الحساب (اختياري)",
    no_account: "بدون تحديد حساب",
    placeholder: "اكتب سؤالك المالي هنا...",
    no_response: "تعذر الحصول على رد من أبوفهد حالياً.",
    connection_error: "تعذر الاتصال بأبوفهد. حاول مرة أخرى.",
    details: "تفاصيل",
    latency_note: "ملاحظة: قد يتأخر الرد 10-30 ثانية حسب الضغط."
  },
  dashboard: {
    title: "لوحة التحكم",
