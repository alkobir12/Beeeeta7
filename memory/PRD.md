...
- ✅ **القيود اليومية** (`/accounting/journal-entries`) - **محدّث 25 يناير 2025**
  - ✅ **CRUD كامل للقيود اليدوية (جديد)**
    - إنشاء قيد يدوي جديد مع نموذج تفاعلي
    - تعديل القيود اليدوية
    - حذف القيود اليدوية مع نافذة تأكيد
    - التحقق التلقائي من توازن القيد
  - تصميم جديد ببطاقات ملونة مع أيقونات
  - فلترة حسب الحالة والنوع (يدوي/آلي)
...
POST /api/whatsapp-bot/webhook/infobip           - Webhook الرسائل
```
...
### P0 - أولوية عالية (مكتملة ✅)
- [x] ~~CRUD كامل للقيود اليدوية (إضافة، تعديل، حذف)~~ ✅ 25 يناير 2025

### P1 - أولوية متوسطة
- [ ] تحسين سرعة التطبيق (Code Splitting باستخدام React.lazy)
- [ ] تطبيق نظام الثيمات على جميع الصفحات (Dashboard, Vehicle Details, إلخ)
- [ ] رفع إيصال الدفع
...
| التاريخ | الوصف |
|---------|-------|
| 25 يناير 2025 | **إضافة CRUD كامل للقيود اليدوية** - إنشاء، تعديل، حذف |
...
- ✅ القيود اليدوية تُحفظ في جدول `journal_entries` في Supabase
- ✅ الميزانية وميزان المراجعة متوازنان

### الاختبارات
- ✅ Backend: 100% نجاح (9/9 اختبارات)
- ✅ Frontend: 100% نجاح
