...
- إضافة نافذة اختيار الطباعة الفورية أو إرسال PDF عبر واتس اب من صفحات العمليات والملف الفني.
- دعم الطباعة التلقائية عبر /print مع تمرير البيانات مباشرة دون الحاجة لصفحة المستندات.
